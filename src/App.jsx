...
export default function App() {
  ...
  async function saveTeamSharedOutcome(ticketId,sharedOutcome){
    const {error}=await supabase.rpc("save_my_team_shared_outcome",{p_assigned_ticket_id:ticketId,p_shared_outcome:sharedOutcome});
    if(error) throw error;
    await refreshAssignedTickets(session);
  }
        ...
        <div style={{maxWidth:1040,fontFamily:"'Inter',sans-serif"}}>
          ...
          <div className="detail-grid">
            ...
            <div>
              ...
              <TeamContribution ticket={at} onSave={onSaveTeamContribution} onSaveSharedOutcome={onSaveTeamSharedOutcome}/>
